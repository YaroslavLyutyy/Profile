...
public class StudentsTest {
    ...
    public void createStudentTest(){
        ...
        driver.findElement(By.cssSelector("div.main-content #icon_prefix")).sendKeys("Vasiliy");
        driver.findElement(By.cssSelector("div.main-content #icon_telephone")).clear();
        driver.findElement(By.cssSelector("div.main-content #icon_telephone")).sendKeys("1234567");
